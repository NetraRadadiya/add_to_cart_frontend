...
function Fetchdata(){
    fetch("https://add-to-cart-backend-3dna.onrender.com/pitches")
    .then((res)=>res.json())
    .then((data)=>{
        CardList(data)
        productdata=data
...
function DeleteProduct(id){
    fetch(`https://add-to-cart-backend-3dna.onrender.com/pitches/${id}`,{
        method:"DELETE"
    }).then((res)=>res.json())
    .then((data)=>{
        alert("deleted...")
...
updatePitchBtn.addEventListener("click",()=>{
    ...
    fetch(`https://add-to-cart-backend-3dna.onrender.com/pitches/${updateProductData.id}`,{
        method:"PUT",
        headers:{
            "Content-Type":"application/json"
        },
